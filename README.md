...
local Window = OrionLib:MakeWindow({Name = "PHX HUB PREMIUM ", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "PHX HUB PREMIUM "})
...
IQ:AddToggle({
    ...
    Callback = function(Value)
        ...
        IQ:AddLabel("Cho thằng nào đell hiểu thì đây là t�? động đánh hình nộm")
    ...
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                ...
                OrionLib:MakeNotification({
                    Name = "PHX HUB V7(Noitification)",
                    Content = "[VN] : Làm ơn hủy nhiệm v�? farrm level(nếu có)",
                    Image = "rbxassetid://119980140458596",
                    Time = 9
                })
            end
